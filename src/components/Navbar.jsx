...
function Navbar ({ activePage, handleNavClick, isNavbarOpen, toggleNavbar }) {
  return (
    <>
      <div
        className={`2xl:w-55 xl:w-48 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-5 pl-6 pb-14 md:pb-0 absolute md:relative z-10 transition-transform duration-300 ${
